...
import com.free.wallpaper.download.activities.MainActivity;
...
public class NotificationUtils {
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_about_bug_report_black_48px)
    ...
    private static Action ignoreReminderAction(Context context) {
        Intent ignoreReminderIntent = new Intent(context, ChangeWallpaperService.class);
        ignoreReminderIntent.setAction("this");
    ...
    private static Action drinkWaterAction(Context context) {
        Intent incrementWaterCountIntent = new Intent(context, ChangeWallpaperService.class);
        incrementWaterCountIntent.setAction("That");
